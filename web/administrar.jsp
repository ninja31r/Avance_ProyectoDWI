  ...
  <div class="container text-center py-5">
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-10 col-sm-6 col-md-4">
        <a href="/usuarios" class="d-flex align-items-center justify-content-center bg-primary text-white text-decoration-none rounded-4 p-5 shadow h-100">
      ...
      <div class="col-10 col-sm-6 col-md-4">
        <a href="/servicios" class="d-flex align-items-center justify-content-center bg-purple text-white text-decoration-none rounded-4 p-5 shadow h-100" style="background-color: #6f42c1;">
